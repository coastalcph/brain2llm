...
wandb.init(
    project="b2l_precision_rough_dim100",
    name=f"{params.src_lang}_{params.tgt_lang}",
    group=f"{params.tgt_lang}",
    tags=[f"{params.src_lang}",f"{params.tgt_lang}"[:-2], f"{params.tgt_lang}"[-2:]]
    )
...
wandb.log({
    ...
    "precision_at_1-csls_knn_10":to_log["precision_at_1-csls_knn_10"] ,
    "precision_at_5-csls_knn_10":to_log["precision_at_5-csls_knn_10"] ,
    "precision_at_10-csls_knn_10":to_log["precision_at_10-csls_knn_10"] ,
