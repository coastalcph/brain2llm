...
#SBATCH --ntasks=1 --cpus-per-task=4 --mem=40GB
...
python3 pipeline.py --config brain_bert/test_${SIZE[0]}_config.yaml --model:is_avg False --convert_parameters:vec_dim 0
