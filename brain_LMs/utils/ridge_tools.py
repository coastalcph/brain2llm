...
def cross_val_ridge(dic,train_features,train_data, n_splits = 10,
    ...
    for icv, (trn, val) in enumerate(kf.split(train_data)):
        ...
        if do_plot:
            ...
            plt.savefig(f"{dic['output_dir']}layer_{dic['layer']}_{dic['subject']}_cost.png")
        r_cv += cost
        #if icv%3 ==0:
        #    print(icv)
    ...
    if do_plot:
        ...
        plt.savefig(f"{dic['output_dir']}layer_{dic['layer']}_{dic['subject']}_r_cv.png")
    ...
    if do_plot:
        ...
        plt.savefig(f"{dic['output_dir']}layer_{dic['layer']}_{dic['subject']}_weights.png")
